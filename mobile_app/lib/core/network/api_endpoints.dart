class ApiEndpoints {
  ...
  static const String refreshToken =
      '/auth/refresh-token'; // Khác với thiết kế ban đầu
  ...
  static const String availableProductsByStore =
  ...
  static const String myDeliveries =
      '/orders/my-deliveries'; // Shipper deliveries
  static const String availableOrders =
      '/orders/available'; // Available for shipper
